  ...
  return (
    <div style={styles.homeContainer}>
      ...
      <div style={styles.textContainer}>
        ...
        <p style={styles.subHeading}>Explore a fully automated Online Course Learning Management System.</p>
      ...
      <div style={styles.illustrationContainer}>
        <img src="https://pbs.twimg.com/profile_images/1438785247936761859/041HNU84_400x400.jpg" alt="Illustration" style={styles.illustration} />
      </div>
    </div>
  );
};
